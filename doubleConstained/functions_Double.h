...
class Zone_Class
{
    ...
    public:
        ...
        void calculate_flows_double_bus(vector<Zone_Class>&, int , double,vector <double> ,vector <double>  ) ;
...
void calculate_normalisation_terms(vector<Zone_Class>&,vector<double>& , vector<double>& ,double);
